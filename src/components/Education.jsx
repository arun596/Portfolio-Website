      ...
      <div className="relative">
        ...
        {educationn.map((edu, index) => (
          <div
            ...
            {/* Timeline Circle */}
            <div className="absolute left-1/2  transform -translate-x-1/2 bg-gray-400 border-4 border-[#e32727] w-12 h-12 sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-10">
              <img
                src={edu.img}
                alt={edu.school}
